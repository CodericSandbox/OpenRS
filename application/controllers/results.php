...
class Results extends CI_Controller {
	...
	if ($data['results']) {
	    ...
	    $sections = array('content' => 'site/' . $this->setting['current_theme'] . '/template/results/category_results_content', 'sidebar' => 'site/' . $this->setting['current_theme'] . '/template/results/results_sidebar');
		...
		$sections = array('content' => 'site/' . $this->setting['current_theme'] . '/template/results/category_no_results', 'sidebar' => 'site/' . $this->setting['current_theme'] . '/template/results/results_sidebar');
		$this->template->load('site/' . $this->setting['current_theme'] . '/template/template', $sections, $data);
	    } else {
		...
		$sections = array('content' => 'site/' . $this->setting['current_theme'] . '/template/results/category_does_not_exist', 'sidebar' => 'site/' . $this->setting['current_theme'] . '/template/results/results_sidebar');
		$this->template->load('site/' . $this->setting['current_theme'] . '/template/template', $sections, $data);
	    }
	}
    }
	...
	if ($data['results']) {
	    ...
	    $sections = array('content' => 'site/' . $this->setting['current_theme'] . '/template/results/search_results_content', 'sidebar' => 'site/' . $this->setting['current_theme'] . '/template/results/results_sidebar');
	    $this->template->load('site/' . $this->setting['current_theme'] . '/template/template', $sections, $data);
	} else {
	    // no results so show 'results/search_no_results' page
	    debug('no results found');
	    debug('loading "results/search_no_results" view');
	    $sections = array('content' => 'site/' . $this->setting['current_theme'] . '/template/results/search_no_results', 'sidebar' => 'site/' . $this->setting['current_theme'] . '/template/results/results_sidebar');
	    if (trim($keyword) !== '') {
