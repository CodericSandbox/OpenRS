    ...
    function show($requested_review_title) {
        ...
        if ($data['review']) {
            ...
            if (($data['review']->approved > 0) OR ($managerLoggedIn) OR ($approval_required == 0)) {
                ...
                $sections = array('content' => 'site/' . $this->setting['current_theme'] . '/template/review/review_content', 'sidebar' => 'site/' . $this->setting['current_theme'] . '/template/review/review_sidebar');
                ...
                $sections = array('content' => 'site/' . $this->setting['current_theme'] . '/template/review/review_pending', 'sidebar' => 'site/' . $this->setting['current_theme'] . '/template/review/review_sidebar');
                $this->template->load('site/' . $this->setting['current_theme'] . '/template/template.tpl', $sections, $data);
            }
        } else {
