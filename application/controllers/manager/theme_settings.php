...
class Theme_settings extends CI_Controller {
	...
	if ($this->input->post('settings_submit')) {
		...
		array(
		    ...
		    'rules' => 'trim|required|callback__more_than_zero|max_length[4]|numeric|xss_clean'
		),
		array(
		...
		array(
		    ...
		    'rules' => 'trim|required|callback__more_than_zero|max_length[7]|numeric|xss_clean'
		),
		array(
