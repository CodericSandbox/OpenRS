...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<title>Open Review Script - Install</title>
	...
	<div id="container">
	    ...
	    <div id="main_section">
		<div id="content">
		    <h1>Open Review Script Installer</h1>
		    <p>Full installation Instructions Are Available At <u><a target="_blank" href="http://openreviewscript.org/docs/doku.php?id=installation">OpenReviewScript.org</a></u></p>					    
		    <?php
			...
			if (isset($_POST['info_form'])) {
				...
				if (mysql_connect($db['default']['hostname'], $db['default']['username'], $db['default']['password'])) {
					...
					?>
		    			...
		    			<li>to visit your manager area <b><a href="../manager" target="_blank">click here</a></b></li>
		    			<li>for help getting started with your site see our <b><a href="http://openreviewscript.org/docs/doku.php?id=userguide" target="_blank">User Guide</a></b></li>
		    			<li>and for more help and support visit our <b><a href="http://openreviewscript.org/forums" target="_blank">forums</a></b></li>
		    		    </ul>
		    		    <br/>
		    			<p><b><span style="color:#ff0000;">IMPORTANT - You must now delete the /install folder, if you don't your site could be vulnerable to security attacks</span></b></p>
					    <?php
					    exit;
					}
				    }
			...
			if ($show_info_form === TRUE) {
    			...
    			<b>We just need a little more information to complete your Open Review Script installation... You can change any of this information after installation</b>
			...
			if ((isset($_POST['settings_form'])) OR ($fill_in_form === TRUE) OR ($connect_fail === TRUE) OR ($database_fail === TRUE)) {
    			...
    			<b>Open Review Script needs to connect to your database. Enter your database connection details below. If you don't know this information, contact your hosting provider for help.</b><br /><br />
    			<form class="myform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
				...
				?>
				<h2><?php echo $image_start . 'tick' . $image_end; ?><b> Your server meets all the requirements for running Open Review Script!</b></h2>
				<?php
			    } else {
				if ($cURL_fail === TRUE) {
