 ...
 * @license		This file is part of OpenReviewScript - free software licensed under the GNU General Public License - http://OpenReviewScript.org/license
 ...
 */
	...
	{
	    echo('<div align="center" style="min-height:30px"><h3><font color="red">The \'install\' directory has not been deleted - to remove this message delete the directory</font></h3></div>');
	}
/*
 *---------------------------------------------------------------
