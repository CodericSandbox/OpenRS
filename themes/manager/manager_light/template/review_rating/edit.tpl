...
<div id="content">
      <div class="myform">
            ...
            <p>&nbsp;</p>
                        <p class="manager_right_link">{{= lang('manager_review_ratings_go_back') }}<strong>"{{= anchor('manager/review_ratings/show/' . $review->id, $review->title) }}"</strong></p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <form id="form" class="myform" name="form" method="post" action="{{= base_url() . 'manager/review_rating/edit/' . $review_rating->id }}">
                  ...
                  <input type="submit" name="review_rating_submit" id="button" value="{{= lang('manager_review_ratings_form_submit_button') }}" />
            </form>
      </div>
</div>