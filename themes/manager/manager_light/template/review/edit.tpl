...
<div id="content">
      <div class="myform">
            ...
            {{ endif }}
            <p>&nbsp;</p>
            <p class="manager_right_link"><strong>-> {{= anchor('manager/reviews', lang('manager_review_manage_back_to_reviews')) }}</strong></p>
            <p>&nbsp;</p>
            <p class="manager_right_link"><strong>-> {{= anchor('review/show/'.$review->seo_title, lang('manager_review_preview'), 'target="_blank"') }}</strong></p>
            <p>&nbsp;</p>
            <p class="manager_right_link"><strong>-> {{= anchor('manager/comments/show/'.$review->id, lang('manager_review_manage_comments')) }}</strong></p>
            <p>&nbsp;</p>
            <p class="manager_right_link"><strong>-> {{= anchor('manager/review_ratings/show/'.$review->id, lang('manager_review_manage_ratings')) }}</strong></p>
            <p>&nbsp;</p>
            ...
            <form id="form" accept-charset="UTF-8" class="myform" name="form" method="post" enctype="multipart/form-data" lang="ru" action="{{= base_url() . 'manager/review/edit/' . $review->id }}">
                  <div class="formblock">
                        ...
                        <div class="formright">
                              <input class="strong" type="text" name="title" id="title" value="{{= set_value('title', $review->title) }}"/>
                              {{= form_error('title') }}
                        </div>
                  </div>
                  <div class="formblock">
                        ...
                        <div class="formright">
                              <textarea cols="40" rows="10" class="long" name="description" id="description">{{= set_value('description', $review->description) }}</textarea>
                  ...
                  <div class="formblock">
                        ...
                        <div class="formright">
                              <input class="strong" type="text" name="vendor" id="vendor" value="{{= set_value('vendor',$review->vendor) }}"/>
                              {{= form_error('vendor') }}
                        </div>
                  </div>
                  <div class="formblock">
                        ...
                        <div class="formright">
                              <input class="strong" type="text" name="link" id="link" value="{{= set_value('link', $review->link) }}"/>
                              {{= form_error('link') }}
                        </div>
                  </div>
                  <div class="formblock">
                        ...
                        <div class="formright">
                              <input class="strong" type="text" name="meta_keywords" id="titmeta_keywordsle" value="{{= set_value('meta_keywords', $review->meta_keywords) }}"/>
                  ...
                  <div class="formblock">
                        ...
                        <div class="formright">
                              <input class="strong" type="text" name="meta_description" id="meta_description" value="{{= set_value('meta_description', $review->meta_description) }}"/>
                              {{= form_error('meta_description') }}
                        </div>
                  </div>
                  <input type="submit" name="review_submit" id="button" value="{{= lang('manager_review_form_submit_button') }}" />
            </form>
      </div>
</div>
