...
<div id="content">
      <div class="myform">
            ...
            <p class="manager_right_link"><strong>-> {{= anchor('manager/pages', lang('manager_page_manage_back_to_pages')) }}</strong></p>
            <p>&nbsp;</p>
            <p class="manager_right_link"><strong>-> {{= anchor('page/show/'.$page->seo_name, lang('manager_page_preview'), 'target="_blank"') }}</strong></p>
            <p>&nbsp;</p>            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <form id="form" class="myform" name="form" method="post" action="{{= base_url() . 'manager/page/edit/' . $page->id }}">
                  <div class="formblock">
                        <div class="formleft">
                        ...
                        <div class="formright">
                              <input class="strong" type="text" name="name" id="name" value="{{= set_value('name',$page->name) }}"/>
                              {{= form_error('name') }}
                        </div>
                  </div>
                  <div class="formblock">
                        ...
                        <div class="formright">
                              <textarea cols="40" rows="10" class="long" name="content" id="pagecontent">{{= set_value('content',$page->content) }}</textarea>
                              {{= form_error('content') }}
                        </div>
                  </div>
                  <div class="formblock">
                        ...
                        <div class="formright">
                              <input class="strong" type="text" name="meta_keywords" id="meta_keywords" value="{{= set_value('meta_keywords',$page->meta_keywords) }}"/>
                  ...
                  <div class="formblock">
                        ...
                        <div class="formright">
                              <input class="strong" type="text" name="meta_description" id="meta_description" value="{{= set_value('meta_description',$page->meta_description) }}"/>
