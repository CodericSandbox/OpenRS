...
<div id="content">
      <div class="myform">
            ...
            <p>&nbsp;</p>
            <form id="form" class="myform" name="form" method="post" action="{{= base_url() . 'manager/feature/edit/' . $feature->id }}">
                  <div class="formblock">
                        <div class="formleft">
                        ...
                        <div class="formright">
                              <input class="strong" type="text" name="name" id="name" value="{{= set_value('name', $feature->name) }}"/>
                              {{= form_error('name') }}
                        </div>
                  </div>
                  <input type="submit" name="feature_submit" id="button" value="{{= lang('manager_feature_form_submit_button') }}" />
            </form>
      </div>
</div>