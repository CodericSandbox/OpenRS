...
<div id="content">
      <div class="myform">
            ...
            {{ endif }}
            <p>&nbsp;</p>
            <form id="form" class="myform" name="form" method="post" action="{{= base_url() . 'manager/comment/add/' . $review->id }}">
                  <div class="formblock">
                        <div class="formleft">
                        ...
                        <div class="formright">
                              <input class="strong" type="text" name="quotation" id="quotation" value="{{= set_value('name', $comment->quotation) }}"/>
                  ...
                  <div class="formblock">
                        ...
                        <div class="formright">
                              <input class="strong" type="text" name="source" id="source" value="{{= set_value('name', $comment->source) }}"/>
                              {{= form_error('source') }}
                        </div>
                  </div>
                  <div class="formblock">
