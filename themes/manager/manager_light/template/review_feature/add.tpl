...
<div id="content">
      <div class="myform">
            ...
            {{ endif }}
            <p>&nbsp;</p>
            <form id="form" class="myform" name="form" method="post" action="{{= base_url() . 'manager/review_feature/add/' . $review->id }}">
                  ...
                  <input type="submit" name="review_feature_submit" style="width:300px" id="button" value="{{= lang('manager_review_features_form_submit_button') }}" />
            </form>
      </div>
</div>