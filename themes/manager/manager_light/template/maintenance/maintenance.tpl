    ...
    */
	...
	<div class="myform">
	    <div class="header_row">{{= lang('manager_maintenance_title') }}</div  >
            <form id="form" class="myform"  name="form" method="post" enctype="multipart/form-data" action="{{= base_url() . 'manager/maintenance' }}">
		<div class="formblock">
		    ...
		    <div class="formright">
			<input type="submit" name="update_sitemap" id="button" value="{{= lang('manager_maintenance_update_sitemap_button') }}" />
		    </div>
		</div>
	    </form>
		...
		<div class="formblock">
		    ...
		    <div class="formright">
			<input type="submit" name="session_submit" id="button" value="{{= lang('manager_maintenance_delete_session_button') }}" />
		    </div>
		</div>
	    </form>
            <form id="form" class="myform" onSubmit="return confirm('{{= lang('manager_maintenance_confirm') }}')" name="form" method="post" enctype="multipart/form-data" action="{{= base_url() . 'manager/maintenance' }}">
		<div class="formblock">
		    ...
		    <div class="formright">
			<input type="submit" name="log_submit" id="button" value="{{= lang('manager_maintenance_delete_log_button') }}" />
		    </div>
		</div>
	    </form>
            <form id="form" class="myform" onSubmit="return confirm('{{= lang('manager_maintenance_confirm') }}')" name="form" method="post" enctype="multipart/form-data" action="{{= base_url() . 'manager/maintenance' }}">
		<div class="formblock">
		    ...
		    <div class="formright">
			<input type="submit" name="cache_submit" id="button" value="{{= lang('manager_maintenance_delete_cache_button') }}" />
		    </div>
		</div>
	    </form>
            <form id="form" class="myform" onSubmit="return confirm('{{= lang('manager_maintenance_confirm') }}')" name="form" method="post" enctype="multipart/form-data" action="{{= base_url() . 'manager/maintenance' }}">
		<div class="formblock">
		    ...
		    <div class="formright">
			<input type="submit" name="repair_submit" id="button" value="{{= lang('manager_maintenance_repair_button') }}" />
		    </div>
		</div>
	    </form>
            <form id="form" class="myform" onSubmit="return confirm('{{= lang('manager_maintenance_confirm') }}')" name="form" method="post" enctype="multipart/form-data" action="{{= base_url() . 'manager/maintenance' }}">
