...
<div id="content">
      ...
      <form id="form" class="myform" name="form" method="post" action="{{= base_url() . 'manager/review_ratings/edit/' . $review->id }}">
	    ...
	    <input type="hidden" name="review_ratings_submit" value="1">
            <input type="submit" name="submit" style="width:300px" id="button" value="{{= lang('manager_review_ratings_form_submit_button') }}" />
      </form>
</div>