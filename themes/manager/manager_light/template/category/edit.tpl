...
<div id="content">
      <div class="myform">
            ...
            <p>&nbsp;</p>
            <form id="form" class="myform" name="form" method="post" action="{{= base_url() . 'manager/category/edit/' . $category->id }}">
            ...
            <div class="myform">
                  ...
                  <form id="form" class="myform" name="form" method="post" action="{{= base_url() . 'manager/category/edit/' . $category->id }}">
                        <div class="formblock">
                              ...
                              <p>&nbsp;</p>
                              <p>&nbsp;</p>
                              <input type="submit" name="category_default_feature_submit" id="button" style="width:300px;"value="{{= lang('manager_category_default_feature_submit') }}" />
                        </div>
                  </form>
            </div>
      {{ endif }}
            ...
            <div class="myform">
                  ...
                  <form id="form" class="myform" name="form" method="post" action="{{= base_url() . 'manager/category/edit/' . $category->id }}">
                        <div class="formblock">
                              ...
                              <p>&nbsp;</p>
                              <p>&nbsp;</p>
                              <input type="submit" name="category_default_rating_submit" id="button" style="width:300px;"value="{{= lang('manager_category_default_rating_submit') }}" />
                        </div>
                  </form>
            </div>
      {{ endif }}
