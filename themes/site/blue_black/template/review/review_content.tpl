...
<div id="content">
	...
	<div class="review_social_bookmarks">
	    <a target="_blank" href="http://www.freescriptsite.com/free-social-bookmark-script/"><img border="0" src="http://www.freescriptsite.com/free-social-bookmark-script/social1.gif" alt=""/></a>
	    <SCRIPT type="text/javaScript" src="http://www.freescriptsite.com/free-social-bookmark-script/bookmark-script.js"></SCRIPT>
	</div>
	<!-- END OF 'SOCIAL BOOKMARKS' SECTION -->
	
	<!-- START OF 'COMMENTS' SECTION -->
	<div class="review_post_message" id="post_message">
	    <a onclick="show_form()" style="text-decoration:underline">{{= lang('review_comment_post_comment_heading') }}</a>
	</div>
