...
<div id="content">
    ...
    <h2 class="heading">{{= lang('results_reviews_in_cat_1') }}&#8220;{{= $category_name }}&#8221;&nbsp;{{= lang('results_reviews_in_cat_2') }}&nbsp;({{= $result_count }}{{= $result_singular_plural }})</h2>
	...
	<div class="description">
	    ...
	    {{= character_limiter(strip_tags($result->description), 300) }}
	...
	<div class="tags">
	    ...
	    {{ $search_index++ }}
	    <form class="tag_form" method="post" name="searchform{{= $search_index }}" action="{{= site_url("results/search") }}">
